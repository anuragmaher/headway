/**
 * MobileThemesDrawer - Mobile drawer for themes list
 */
...
export const MobileThemesDrawer: React.FC = () => {
  const theme = useTheme();
  const {
    themes,
    hierarchicalThemes,
    mobileThemesDrawerOpen,
    showingAllFeatures,
    showingAllFeaturesList,
    selectedThemeForDrawer,
    setMobileThemesDrawerOpen,
  ...
  const handleClose = () => setMobileThemesDrawerOpen(false);

  return (
    <Drawer
      anchor="left"
      open={mobileThemesDrawerOpen}
      onClose={handleClose}
      sx={{
        '& .MuiDrawer-paper': {
          width: '85%',

...
def sync_workspace_slack(self, workspace_id: str, sync_id: str, hours_back: int = 24):
    ...
    try:
        with Session(engine) as db:
            ...
            update_sync_record(db, sync_id, "success", total_messages, total_messages)
            logger.info(f"✅ Slack sync complete: {total_messages} messages")
